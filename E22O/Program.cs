...
namespace Cseveges
{
    internal class Program
    {
        ...
        static void Feladat5()
        {
            ...
            Console.WriteLine($"\tVége:          {Leghosszabb.Veg.ToString("yy.MM.dd-HH:mm:ss")}");
            Console.WriteLine($"\tHossz:         {Ido.TotalSeconds}mp");
        }
        static void Feladat6()
        {
            ...
            Console.WriteLine($"A beszélgetések összes ideje: {String.Format(OsszesIdo.ToString(),"00.00.00")}");
        }
